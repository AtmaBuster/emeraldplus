...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_MT_SILVER_CAVE] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_VIRIDIAN_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PEWTER_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_CERULEAN_CITY] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_KANTO_UNDERWATER] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_UNDERWATER_27] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_26] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_21] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_RUINS_OF_ALPH_INTERIOR] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_ECRUTEAK_CITY] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_MAGNET_TRAIN] = MAPPOPUP_THEME_MARBLE,
};

...
const u32 gObjectEventPic_Red[] = INCBIN_U32("graphics/object_events/pics/pokemon/celebi.4bpp");
const u32 gObjectEventPic_Leaf[] = INCBIN_U32("graphics/object_events/pics/pokemon/jirachi.4bpp");

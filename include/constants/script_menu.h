...
#define MULTI_VERMILION_FERRY              114
#define MULTI_VERMILION_FERRY_2            115
#define MULTI_GOLDENROD_FERRY              116

// Lilycove SS Tidal Multichoice Selections
#define SSTIDAL_SELECTION_SLATEPORT        0
#define SSTIDAL_SELECTION_BATTLE_FRONTIER  1
#define SSTIDAL_SELECTION_VERMILION        2
#define SSTIDAL_SELECTION_SOUTHERN_ISLAND  3
#define SSTIDAL_SELECTION_NAVEL_ROCK       4
#define SSTIDAL_SELECTION_BIRTH_ISLAND     5
#define SSTIDAL_SELECTION_FARAWAY_ISLAND   6
